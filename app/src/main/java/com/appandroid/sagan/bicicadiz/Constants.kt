...
object Constants {
    ...
    const val PARKING_LOCATION_NAME = "name"
    const val PARKING_LOCATION_PHOTO = "url"
    const val STREET_VIEW_LINK = "street_view_link"
    const val CARRIL_BICI_GEO = "carril_bici.geojson"
    const val APARCABICIS_GEO = "aparcabicis.geojson"
    const val FUENTES_GEO = "fuentes.geojson"
